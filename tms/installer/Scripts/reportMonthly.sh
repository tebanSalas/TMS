...
APP_NAME=$1
PATH_LOGS=/home/glassfish/scripts_tms_sfs/logs/sendReportMonthly_$1.log
#Fin Variables a definir

RUTA=$APP_HOME/$INSTANCE_NAME/$APP_NAME/WEB-INF/lib

EXECPATH=`echo $RUTA/*.jar | tr ' ' ':'`:$CLASSPATH
$JAVA_HOME/bin/java -cp $APP_HOME/$INSTANCE_NAME/$APP_NAME/WEB-INF/classes:$EXECPATH com.unify.webcenter.crons.sendReportMonthly > $PATH_LOGS
