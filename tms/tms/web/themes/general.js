  ...
  WM_netscapeCssFixCheckIn();
	...
	function showHideModule(divID, theme) {
		...
		if(w3c) {
			...
			if(divIDobj != null && tlobj != null && toggleobj != null) {
				...
				if(state=="c") {
					if(postnuke=="true") {
						tlobj.src = "modules/PhpCollab/themes/"+theme+"/spacer.gif";
						toggleobj.src = "modules/PhpCollab/themes/"+theme+"/module_toggle_closed.gif";
					} else {
					...
					if(postnuke=="true") {
						tlobj.src = "modules/PhpCollab/themes/"+theme+"/spacer.gif";
						toggleobj.src = "modules/PhpCollab/themes/"+theme+"/module_toggle_open.gif";
					} else {
						tlobj.src = "../themes/"+theme+"/spacer.gif";
	...
	function MM_toggleItem(form, itemName, imageName, theme) {
		...
		if (MM_arrayContainsString(form.selectedItems, itemName)) {
			...
			if(postnuke=="true") {
				document[imageName].src = 'modules/PhpCollab/themes/'+theme+'/checkbox_off_16.gif';
			} else {
			...
			if(postnuke=="true") {
				document[imageName].src = 'modules/PhpCollab/themes/'+theme+'/checkbox_on_16.gif';
			} else {
		...
		if (form.checkboxes) {
			...
			for (i = 0; i < checkboxCount; i++) {
				...
				if (-1 == document[checkbox.mImageName].src.indexOf('dim_16.gif')) {
					if(postnuke=="true") {
						document[checkbox.mImageName].src = 'modules/PhpCollab/themes/'+theme+'/checkbox_on_16.gif';
					} else {
	...
	function MM_deselectAllItems(form, theme) {
		...
		if (form.checkboxes) {
			...
			for (i = 0; i < checkboxCount; i++) {
				...
				if (-1 == document[checkbox.mImageName].src.indexOf('dim_16.gif')) {
					if(postnuke=="true") {
						document[checkbox.mImageName].src = 'modules/PhpCollab/themes/'+theme+'/checkbox_off_16.gif';
					} else {
