 ...
 */
public class sendReportByWeekly {
     ...
     * que se ejecuta la clase menos 16 dias y la fecha final seria el dia que se 
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-----------------------------------");
        System.out.println("     TMS v3.1 Send Report ByWeekly");
        System.out.println("-----------------------------------");
    ...
    public void check() {
        ...
        String Company = null;
        Iterator e = reportBroker.getDailyList("members", "ASC", "Q",1);
        ...
        while (e.hasNext()) {
            ...
            if (!repetidos.isEmpty()) {
                ...
                try {
                    ...
                    FileOutputStream out = new FileOutputStream("Informe_Laboral_Quincenal_" + reportData.getParentMember().getname() + ".xls");
                    ...
                    out.flush();
                    out.close();
                    sm.sendReport("Informe Labores Quincenal " + reportData.getParentMember().getname(), reportData.getNotificationMember().getemail_work(), out, reportData.getParentMember().getname(), "Quincenal");
                    File theFile2 = new File("Informe_Laboral_Quincenal_" + reportData.getParentMember().getname() + ".xls");
                    theFile2.delete();
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
