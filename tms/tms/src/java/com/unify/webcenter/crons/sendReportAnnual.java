...
public class sendReportAnnual {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-----------------------------------");
        System.out.println("     TMS v3.1 Send Report Annual");
        System.out.println("-----------------------------------");
    ...
    public void check() {
        ...
        String Company = null;
        Iterator e = reportBroker.getDailyList("members", "ASC", "A",1);
        ...
        while (e.hasNext()) {
            ...
            if (!repetidos.isEmpty()) {
                ...
                try {
                    ...
                    FileOutputStream out = new FileOutputStream("Informe_Laboral_Anual_" + reportData.getParentMember().getname() + ".xls");
                    ...
                    out.flush();
                    out.close();
                    sm.sendReport("Informe Labores Anual " + reportData.getParentMember().getname(), reportData.getNotificationMember().getemail_work(), out, reportData.getParentMember().getname(), "Anual");
                    File theFile2 = new File("Informe_Laboral_Anual_" + reportData.getParentMember().getname() + ".xls");
                    theFile2.delete();
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
