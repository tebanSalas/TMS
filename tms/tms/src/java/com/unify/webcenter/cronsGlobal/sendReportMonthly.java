 ...
 */
public class sendReportMonthly {
     ...
     * que se ejecuta la clase menos 31 dias y la fecha final seria el dia que se 
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-----------------------------------");
        System.out.println("     TMS v3.1 Send Report Monthly");
        System.out.println("-----------------------------------");
    ...
    public void check() {
        ...
        String Company = null;
        Iterator e = reportBroker.getDailyList("members", "ASC", "M",2);
        ...
        while (e.hasNext()) {
            ...
            if (!lista.isEmpty()) {
                ...
                try {
                    ...
                    FileOutputStream out = new FileOutputStream("Informe_Laboral_Mensual_" + reportData.getParentMember().getname() + ".xls");
                    ...
                    out.flush();
                    out.close();
                    sm.sendReport("Informe Labores Mensual " + reportData.getParentMember().getname(), reportData.getNotificationMember().getemail_work(), out, reportData.getParentMember().getname(), "Mensual");
                    File theFile2 = new File("Informe_Laboral_Mensual_" + reportData.getParentMember().getname() + ".xls");
                    theFile2.delete();
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
