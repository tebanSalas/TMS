 ...
 * @author esper
 */
public class applicationBroker extends MainBroker{
    ...
    public mainData getData(int id) {
        applicationData data = new applicationData();  //todos los datos que vienen de la bd
        ...
        Query query = new QueryByCriteria(applicationData.class, criteria); // a que data pertenece el criteria (como el from del sql)
    ...
    public Iterator getList(String sortColumnName, String sortOrder) throws PersistenceBrokerException {
        ...
        // Query of the exact organization
        Query query = new QueryByCriteria(applicationData.class, criteria); // a que data pertenece el criteria
