...
public class sendReport {
    ...
    private accountsBroker accBroker;
   ...
   /*     try {
    ...
    private void check() {
        ...
        accountsData accData = new accountsData();
